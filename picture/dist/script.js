...
var filter = function filter() {
  ...
  var filterByClick = function filterByClick(btn, mark) {
    btn.addEventListener('click', function () {
      typeFilter(mark);
    });
  };
  filterByClick(btnAll, markAll);
  filterByClick(btnLovers, markLovers);
  filterByClick(btnChef, markChef);
  filterByClick(btnGuy, markGuy);
  filterByClick(btnGirl, markGirl);
  filterByClick(btnGrandmother);
  filterByClick(btnGranddad);
...
var forms = function forms() {
  ...
  var clearInputs = function clearInputs() {
    ...
    promocode.forEach(function (item) {
      item.value = '';
    });
  ...
  form.forEach(function (item) {
    item.addEventListener('submit', function (e) {
      ...
      (0,_services_requests__WEBPACK_IMPORTED_MODULE_7__.postData)(api, formData).then(function (res) {
...
var showMoreStyles = function showMoreStyles(trigger, wrapper) {
  ...
  btn.addEventListener('click', function () {
    (0,_services_requests__WEBPACK_IMPORTED_MODULE_5__.getResource)('assets/db.json').then(function (res) {
